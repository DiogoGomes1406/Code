function  safety_save(path, File_name,Curve_id,...
    ...
    vDS, N_points, Dwell_time, Dwell_voltage, Ids, Vds, Igs, Vgs, t)
...
if isfile(fullfile(path, File_name + ".mat")) 
    ...
    data = file.data;
    disp(data)
    data(end+1,:) = {{Curve_id},DS_comp, GS_comp, Vgs_min, Vgs_max, vDS, N_points, Dwell_time,Dwell_voltage, ...
        {Ids}, {Vds}, {Igs}, {Vgs}, {t}};
    ...
    data = table({Curve_id}, DS_comp, GS_comp, Vgs_min, Vgs_max, vDS, N_points, Dwell_time,Dwell_voltage, ...
         {Ids}, {Vds}, {Igs}, {Vgs}, {t}, ...
        'VariableNames', {'Curve_id','DS_comp', 'GS_comp', 'Vgs_min', 'Vgs_max', ...
